...
from torch.nn.modules.utils import _reverse_repeat_tuple, _single, _triple, _pair

from nn.layers.BaseLayer import BaseLayer
from nn.utils.common_types import size_1_t, size_2_t, size_3_t


class _ConvNd(BaseLayer):
...
class Conv1d(_ConvNd):
    def __init__(
            ...
            in_channels: int,
            out_channels: int,
            kernel_size: size_1_t,
            stride: size_1_t = 1,
            padding: Union[str, size_1_t] = 0,
            dilation: size_1_t = 1,
            groups: int = 1,
            bias: bool = True,
    ...
    def _conv_forward(self, x: Tensor, weight: Tensor, bias: Optional[Tensor]):
        ...
        return F.conv1d(x, weight, bias, self.stride,
...
class Conv3d(_ConvNd):
    def __init__(
            ...
            in_channels: int,
            out_channels: int,
            kernel_size: size_3_t,
            stride: size_3_t = 1,
            padding: Union[str, size_3_t] = 0,
            dilation: size_3_t = 1,
            groups: int = 1,
            bias: bool = True,
...
class _ConvTransposeNd(_ConvNd):
    ...
    # dilation being an optional nn.Parameter is for backwards
    # compatibility
    def _output_padding(self, x: Tensor, output_size: Optional[List[int]],
