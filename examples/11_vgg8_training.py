...
PATH_DATASET = os.path.join('_data', 'DATASET')
...
def load_images():
    ...
    print(f'Normalization _data: ({mean},{std})')
...
def main():
    ...
    # Results include: Loss vs Epoch graph, Accuracy vs Epoch graph and vector _data.
